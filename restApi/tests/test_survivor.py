...
class TestSurvivor(APITestCase):
    ...
    def test_report_infection(self):
        ...
        request = self.client.put(
            'http://localhost:8000/api/v1/survivor/report_infection/1/')
        self.assertEquals(request.status_code, 200)
        ...
        request_2 = self.client.put(
            'http://localhost:8000/api/v1/survivor/report_infection/1/')
        request_3 = self.client.put(
            'http://localhost:8000/api/v1/survivor/report_infection/1/')
    ...
    def test_survivor_trade_notfound_survivor(self):
        ...
        resques_notfound = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/3-food/')
    ...
    def test_survivor_trade_amountdontmatch(self):
        ...
        request_amounterror = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/4-food/2/3-food/')
        self.assertEquals(request_amounterror.status_code, 400)
        self.assertEquals(json.loads(request_amounterror.content)[
                          'error'], "Amount don't match")
    ...
    def test_survivor_trade_itemnotfound(self):
        ...
        request_itemerror = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/1-juice/')

        self.assertEquals(request_itemerror.status_code, 404)
        self.assertEquals(json.loads(request_itemerror.content)[
    ...
    def test_survivor_trade_pointsdontmatch(self):
        ...
        request_pointserror = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/1-water/')

        self.assertEquals(request_pointserror.status_code, 400)
        self.assertEquals(json.loads(request_pointserror.content)[
                          'error'], "Points don't match")
    ...
    def test_survivor_trade_survivorinfected(self):
        ...
        request_infectionserror = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/1-food/')

        self.assertEquals(request_infectionserror.status_code, 400)
        self.assertEquals(json.loads(request_infectionserror.content)[
                          'error'], "Survivor is infected")
    ...
    def test_trade_inventorynotfound(self):
        ...
        request_itemnotfound = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/1-ammunition-1-medication/')

        self.assertEquals(request_itemnotfound.status_code, 404)
        self.assertEquals(json.loads(request_itemnotfound.content)[
                          'error'], "Item in inventory does not exists")
    ...
    def test_trade_success(self):
        ...
        request_sucess = self.client.put(
            'http://localhost:8000/api/v1/survivor/trade_items/1/1-food/2/1-ammunition-1-medication/')
        self.assertEquals(request_sucess.status_code, 200)
        self.assertEquals(json.loads(request_sucess.content)[
                          'Success'], "Exchange made successfully")
